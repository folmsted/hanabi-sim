...
help_hint = 'The "hint" command, short form "h".  Used to indicate'\
...
help_discard = 'The "discard" command, short form "d".  Used to '\
...
help_guess = 'The "guess" command, short form "g".  Used to '\
...
help_quit = 'The "quit" command, short form "q".  Used to quit the simulation.\n'\
            'Usage:\n'\
            'quit'
